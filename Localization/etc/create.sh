...
convert -size 2970x2100 xc:white -density 10x10 -units pixelspercentimeter -fill white result2.png
h=$1
v=$2
for j in $(seq 0 3);do
...
convert result.png \
-fill white -stroke black -draw "ellipse $x,$y 400,400 0,360" \
-fill black -stroke none  -draw "ellipse $x,$y 300,300 0,360" \
...
x=$(($i*800+450)); 
y=$(($j*800+450));
ix=$(((($j*10+5)*$sj/10+30)*2));
iy=$(((($i*10+5)*$si/10+30)*2)); 
# ix=$((($j*10+5)*$sj/10+30));
# iy=$((($i*10+5)*$si/10+30)); 
# -fill white -stroke black -draw "ellipse $x,$y 200,200 0,360" \
...
convert result2.png \
-fill white -stroke black -draw "ellipse $x,$y 400,400 0,360" \
-fill black -stroke none -draw "ellipse $x,$y 260,320 0,360" \
-fill white -stroke none -draw "ellipse $x,$(($y+20)) $ix,$iy 0,360" \
result2.png
...
convert result2.png -density 100x100 result2_$h\_$v.pdf
